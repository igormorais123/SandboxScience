<template>
    <section w-full flex flex-col>
        ...
        <RangeInput input :min="1" :max="selectedCell && selectedCells?.length === 1 ? particleLife.maxRadiusMatrix[selectedCell[0]][selectedCell[1]] : 300" :step="1" v-model="selectedValue" mt-2 >
