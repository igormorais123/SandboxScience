...
export const useParticleLifeGPUStore = defineStore('particleLifeGPU', () => {
    ...
    const trackerExpectedCount = ref<number>(0) // Expected particle count for the tracked creature (read from GPU)
    ...
    return {
        ...
        isTrackerActive, isTrackerSelectionActive, trackerExpectedCount, isTrackerCameraActive,
