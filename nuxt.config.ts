...
export default defineNuxtConfig({
    ...
    app: {
        head: {
            ...
            meta: [
                { name: 'author', content: 'INTEIA' },
                { property: 'og:site_name', content: appName },
                { name: 'twitter:card', content: 'summary_large_image' },
                { name: 'twitter:title', content: appName },
                { name: 'twitter:description', content: appDescription },
                { name: 'twitter:site', content: '@intikiabr' },
                { name: 'twitter:image:alt', content: '@intikiabr' },
        ...
        //     twitterSite: '@intikiabr',
        //     twitterImageAlt: '@intikiabr',
    ...
    schemaOrg: {
        identity: {
            type: 'Organization',
            name: 'INTEIA -- Inteligencia Artificial Estrategica',
            url: 'https://inteia.com.br',
            logo: 'https://inteia.com.br/logo.png',
            sameAs: [
                'https://github.com/igormorais123/SandboxScience',
                'https://inteia.com.br',
            ],
        }
    },
